...
<div class=" col-md-12">
  ...
  <div class="panel panel-white">
      ...
      <div class="panel-body">
              <div class="row">
                      <div class="col-md-12">
                      <form role="form" action="{{route('treatments.store')}}" method="POST">
                          @csrf
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="label" name="colors">
                <small>input colors separating by commas or leave blank if there are no colors</small>
            </div><!--form-group-->
            </div><!--col-md-3-->
            <div class="col-md-3">
              <div class="form-check">
                <input class="form-check-input" type="radio" value="single" id="printing_single" name="sides">
            ...
            <div class="col-md-3">
              <div class="form-check">
                <input class="form-check-input" type="radio" value="both" id="printing_both" name="sides">
