...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="card my-4">
                ...
                <a href="javascript:void(0);" class="card-link btn btn-success" @click="deleteRecord({{$quantity->id}})">Delete</a>
                <form action="{{route('quantity.destroy',$quantity->id)}}" id="form-delete-{{$quantity->id}}" method="POST">
                        @method('delete')
                        @csrf
                        </form>
                    </div>
