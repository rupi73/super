...
<div class=" col-md-12">
        ...
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                    <div class="row">
                            <div class="col-md-6">
                            <form role="form" action="{{route('quantity.update',$quantity->id)}}" method="POST">
                                @csrf
                                @method('PATCH')
                    <div class="form-group">
                        <label for="label">Label</label>
                    <input type="text" class="form-control" id="label" name="label" value="{{$quantity->label}}">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="value" name="value" value="{{$quantity->value}}">
                        </div>
                        </div>
                </div>
